/* @ts-self-types="./crdt_engine.d.ts" */
...
export class CrdtDoc {
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        CrdtDocFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_crdtdoc_free(ptr, 0);
    }
    /**
     * @param {any} op
     */
    applyRemote(op) {
        const ret = wasm.crdtdoc_applyRemote(this.__wbg_ptr, op);
        if (ret[1]) {
     ...
     */
    delete(index) {
        const ret = wasm.crdtdoc_delete(this.__wbg_ptr, index);
        return ret;
    }
    /**
     * @param {number} index
    ...
    insert(index, ch) {
        ...
        _assertChar(char0);
        const ret = wasm.crdtdoc_insert(this.__wbg_ptr, index, char0);
        return ret;
    }
    /**
     * @returns {boolean}
     */
    isEmpty() {
        const ret = wasm.crdtdoc_isEmpty(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     * @returns {number}
     */
    len() {
        const ret = wasm.crdtdoc_len(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     ...
     */
    constructor(site_id) {
        const ret = wasm.crdtdoc_new(site_id);
        this.__wbg_ptr = ret;
        CrdtDocFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     * @returns {number}
     */
    siteId() {
        const ret = wasm.crdtdoc_siteId(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {string}
    ...
    toString() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.crdtdoc_toString(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
...
if (Symbol.dispose) CrdtDoc.prototype[Symbol.dispose] = CrdtDoc.prototype.free;
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./crdt_engine_bg.js": import0,
    };
}

const CrdtDocFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_crdtdoc_free(ptr, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('crdt_engine_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
